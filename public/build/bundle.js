...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (script.src !== (script_src_value = "https://cdn.babylonjs.com/viewer/babylon.viewer.js")) attr_dev(script, "src", script_src_value);
    			add_location(script, file, 107, 1, 3277);
    			attr_dev(canvas, "id", "renderCanvas");
    			attr_dev(canvas, "class", "svelte-xznatn");
    			add_location(canvas, file, 112, 1, 3495);
    			add_location(main, file, 111, 0, 3487);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_slots("Vr_video", slots, []);
    	let { video = "video360avion480p.mp4" } = $$props;
    	let { cameraType = "default" } = $$props;
    	let camera = null;
    	let scene = null;
    	...
    	const writable_props = ["video", "cameraType"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Vr_video> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("cameraType" in $$props) $$invalidate(3, cameraType = $$props.cameraType);
    	};
    	...
    	return [canvasElement, init, video, cameraType, canvas_binding];
    }

    class Vr_video extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, not_equal, { video: 2, cameraType: 3 });
    	...
    	get video() {
    		throw new Error("<Vr_video>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set video(value) {
    		throw new Error("<Vr_video>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
